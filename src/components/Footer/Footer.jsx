    ...
    <Container id="footer">
      <Profile>
        ...
        <div className="address">
          ...
          <Slide direction="left">
            <p>HNo-465, Balaji Nagar, Padgha, Bhiwandi, Thane, Maharashra- 421101</p>
          </Slide>
        </div>
        <div className="links">
          <Slide direction="left">
          ...
          <div>
            ...
            <Slide direction="left">
              <a href="tel:+91 8698124581">+91 8698124581</a>
            </Slide>
          </div>
          <div>
            <Slide direction="left">
            ...
            <Slide>
              <a href="mailto:haradyash0244@gmail.com" target="_blank" rel="noreferrer">haradyash0244@gmail.com</a>
            </Slide>
          </div>
        </div>
